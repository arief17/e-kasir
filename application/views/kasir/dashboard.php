                        ...
                        <div class="list-group list-lg-group list-group-flush">
                            <div class="list-group-item list-group-item-action" href="javascript:void(0);">
                                <div class="media mt-0">
                                    <img class="avatar-lg rounded-circle my-auto me-3" src="<?= base_url() ?>assets/img/faces/3.jpg" alt="Image description">
                            ...
                            <div class="list-group-item list-group-item-action br-t-1" href="javascript:void(0);">
                                <div class="media mt-0">
                                    <img class="avatar-lg rounded-circle my-auto me-3" src="<?= base_url() ?>assets/img/faces/11.jpg" alt="Image description">
                                    <div class="media-body">
                                        <div class="d-flex align-items-center">
                                            <div class="mt-1">
                            ...
                            <div class="list-group-item list-group-item-action br-t-1" href="javascript:void(0);">
                                <div class="media mt-0">
                                    <img class="avatar-lg rounded-circle my-auto me-3" src="<?= base_url() ?>assets/img/faces/17.jpg" alt="Image description">
                                    <div class="media-body">
                                        <div class="d-flex align-items-center">
                                            <div class="mt-1">
                            ...
                            <div class="list-group-item list-group-item-action br-t-1" href="javascript:void(0);">
                                <div class="media mt-0">
                                    <img class="avatar-lg rounded-circle my-auto me-3" src="<?= base_url() ?>assets/img/faces/15.jpg" alt="Image description">
                                    <div class="media-body">
                                        <div class="d-flex align-items-center">
                                            <div class="mt-1">
                            ...
                            <div class="list-group-item list-group-item-action br-t-1 br-br-7 br-bl-7" href="javascript:void(0);">
                                <div class="media mt-0">
                                    <img class="avatar-lg rounded-circle my-auto me-3" src="<?= base_url() ?>assets/img/faces/6.jpg" alt="Image description">
                                    <div class="media-body">
                                        <div class="d-flex align-items-center">
                                            <div class="mt-1">
